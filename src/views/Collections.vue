  ...
  <div class="flex w-full min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
    ...
    >
      ...
      >
        <button
          :class="
            sidebarTab === 'userlists' ? 'border-b-2 border-[#009de0] text-[#009de0] pb-2' : 'pb-2'
          "
        ...
        <button
          :class="
            sidebarTab === 'bookmarks' ? 'border-b-2 border-[#009de0] text-[#009de0] pb-2' : 'pb-2'
          "
...
const filters = ['All 0', 'Active 0', 'Expired 0', 'Restricted 0', 'Blocked 0']
